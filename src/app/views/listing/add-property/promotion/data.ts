...
export const pricingPlansData: PricingPlan[] = [
  {
    ...
    buttonText: 'Select Easy Start',
    buttonClass:
      'w-full text-info border border-info py-3.5 px-6 rounded-md bg-transparent transition-all duration-300 hover:text-white hover:bg-info font-semibold',
    svg: `<svg class="md:mb-6 mb-4" xmlns="http://www.w3.org/2000/svg" width="56" height="56" fill="none">
  ...
  },
  {
    ...
    buttonText: 'Select Fast Start',
    buttonClass:
      'w-full py-3.5 px-6 rounded-md transition-all duration-300 text-white bg-info hover:bg-info/90 font-semibold',
    svg: `<svg class="md:mb-6 mb-4" xmlns="http://www.w3.org/2000/svg" width="56" height="56" fill="none">
                                <path class="text-info" d="M44.136 9.966c5.79 4.746 9.491 11.864 9.491 19.932 0 14.142-11.485 25.627-25.627 25.627S2.373 44.041 2.373 29.898 13.858 4.271 28 4.271v5.695c-11.01 0-19.932 8.922-19.932 19.932S16.99 49.831 28 49.831s19.932-8.922 19.932-19.932c0-7.973-4.746-14.807-11.485-18.034h.095 7.593V9.966z" fill="currentColor"></path>
                                <path class="text-primary" d="M44.136 9.966v1.898h-7.593V9.966 2.373h7.593v7.593z" fill="currentColor"></path>
                                <path class="text-info" d="M28 21.356c-4.746 0-8.542 3.797-8.542 8.542s3.797 8.542 8.542 8.542 8.542-3.797 8.542-8.542-3.796-8.542-8.542-8.542zm0-5.695a14.22 14.22 0 0 1 14.237 14.237A14.22 14.22 0 0 1 28 44.136a14.22 14.22 0 0 1-14.237-14.237A14.22 14.22 0 0 1 28 15.661z" fill="currentColor"></path>
...
export const promotionData: PromotionType[] = [
  {
    id: 'certify',
    title: 'Check and certify my ad by Finder experts',
    description: 'Ads with Certified badge get 10x more views.',
    price: '$35',
  },
  {
    id: 'lifts',
    title: '10 lifts to the top of the list (daily, 7 days)',
    description: 'Your ad will be seen by as many people as possible.',
    price: '$29',
    duration: '/month',
    checked: true,
  },
  {
    id: 'analytics',
    title: 'Detailed user engagement analytics',
    description:
      'Benefit from comprehensive data analysis, including demographic insights and engagement trends.',
    price: '$15',
    duration: '/month',
  },
];